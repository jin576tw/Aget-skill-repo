...
| **angular-unit-test-writer** | Angular 單元測試師 | 依 AC 產生紅燈 Jasmine/TestBed 測試（不負責實作）|
| **vue-unit-test-writer** | Vue 2 / Nuxt 2 單元測試師 | 依 AC 產生紅燈 Jest / Vue Test Utils v1 測試（不負責實作） |
| **java-unit-test-writer** | Java 後端測試師 | 依 AC 產生紅燈 JUnit 5 / Mockito 測試；Step 7 補 MockMvc API 整合測試 |
